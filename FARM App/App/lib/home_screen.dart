...
class HomeScreen extends StatelessWidget {
  ...
  // Re-added the confirmation dialog logic
                ...
                children: [
                  ...
                  _buildMenuCard(
                    ...
                    onTap: () {
                      showAboutDialog(
                        context: context,
                        applicationName: "AI Crop Predictor",
                        applicationVersion: "1.0.0",
                        applicationIcon: const Icon(Icons.eco, color: Colors.green, size: 40),
                        children: [
                          const Text("Empowering farmers with AI-driven soil analysis."),
                        ],
                      );
                    },
                  ),
                  _buildMenuCard(
                    ...
                    isLogout: true, // Mark this to trigger red text
                    onTap: () => _showLogoutDialog(context), // Re-enabled dialog
                  ),
                ],
              ),
            );
      ...
      child: ListTile(
        ...
        title: Text(
          ...
          style: GoogleFonts.poppins(
              ...
              fontSize: 18,
              color: isLogout ? Colors.redAccent : Colors.black87 // Red text for Logout
          ),
        ),
        subtitle: Text(
          subtitle,
